...
function OpportunityPanel({ opportunity, onClose, onOverride, onRescore }: { opportunity: Opportunity; onClose: () => void; onOverride: (value: number) => void; onRescore: (opportunity: Opportunity, ratings: Record<string, number>, notes: string) => void }) {
